    ...
    return (
        <section className={style.BestSellers}>
            <div className={style.container}>
                <div className={style.BestSellers_title}>
                    <h3>Best Sellers</h3>
                </div>
                            ...
                            return (
                                <div className={style.card}>
                                    <div className={style.card__top}>
                                        <a href="#" className={style.card__image}>
                                            <img
                                                src={product.image}
                                                alt="product"
                                            />
                                        </a>
                                        <div className={style.card__label}>discount%</div>
                                    </div>
                                    <div className={style.card__bottom}>

                                        <div className={style.common}>{product.price} $</div>
